INSERT INTO saas_modules(module_key, display_name, category, enabled_default, license_scope)
VALUES ('manufacturing', 'Manufacturing', 'business', true, 'commercial')
...
SELECT id, platform.organization_schema_name(id), 'meta-org.industry-solution-manifest.v1', 'pending', '{"source":"006_saas_manufacturing_module_seed"}'::jsonb
